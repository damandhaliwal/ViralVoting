...
For the Civic Duty, Self and Neighbors treatments, the estimates of $\beta_2$, the coefficient of the interaction term, are statistically indistinguishable from zero, implying no diffusion effects. However, for the Hawthorne treatment, while $\beta_2$ is positive and significant, $\beta_1$, the coefficient for the treatment directly, becomes statistically insignificant when interaction terms are included. This instability prevents us from reliably estimating $\lambda$ for any treatment group.
...
The deployment of Causal Machine Learning methods (specifically X-Learners and Causal Forests) was instrumental in revealing the hidden non-linear structure of the diffusion process that traditional linear models could not capture. At low levels of neighborhodod treatment intensity, social pressure fails to establish strong norms, moderate intensity is revealed as optimal where community creates positive reinforcement without being overbearing. High intensity neighborhoods suggested a social saturation effect and a decline in the effect of the pressure treatment.

These findings have important implications for understanding how social pressure campaigns function. They suggest that while direct appeals can effectively mobilize voters, simply saturating a neighborhood with treatment may not yield additional benefits and could even backfire due to free-riding dynamics. Future campaigns should consider targeting moderate intensity levels to optimize turnout effects, creating clusters of social pressure large enough to spark conversation but small enough to avoid triggering community fatigue.
