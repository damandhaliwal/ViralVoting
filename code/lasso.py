# lasso save coefficients and coefficient plots
# Daman Dhaliwal
import os
...
def run_lasso_analysis(plot_top_n=None):
    ...
    metrics_path = output_dir + 'lasso_metrics.tex'
    ...
    coef_path = output_dir + 'lasso_coefficients.tex'
...
def _create_coefficient_plot(results, paths, plot_top_n=None):
    ...
    # Set Y-limits based on the features we are actually plotting
    ...
    output_path = output_dir + 'figure3a.png'
